...
- [ ] Rename all deliverable-fossils and naming-lies across cli, engine, models, plugin-claude, and plugin-cursor test files (Findings 1-3, 7-11, 13, 16-18) — estimated L2
