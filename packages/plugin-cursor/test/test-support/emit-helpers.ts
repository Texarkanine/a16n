/**
 * Shared helpers for Cursor plugin emit tests.
 *
...
/**
 * Per-suite temp root under `packages/plugin-cursor/test/.temp-emit/<slug>/`
...
export function suiteTempDir(importMetaUrl: string | URL, slug: string): string {
  const url =
    typeof importMetaUrl === 'string' ? importMetaUrl : importMetaUrl.href;
