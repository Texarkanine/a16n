...
Unified Docusaurus site in `packages/docs`. Hand-written guides plus TypeDoc-generated API reference. API markdown is generated at CI build time only—never committed, never in anyone's local clone.
