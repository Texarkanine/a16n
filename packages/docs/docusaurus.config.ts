...
import {buildLlmsPluginOptions} from './scripts/llms-plugin-options';

const __filename = fileURLToPath(import.meta.url);
const __dirname = dirname(__filename);
const generatedRoot = join(__dirname, '.generated');
...
const config: Config = {
  ...
  url: 'https://texarkanine.github.io',
  ...
  organizationName: 'Texarkanine', // Usually your GitHub org/user name.
      ...
      'classic',
      {
        docs: {
          ...
          async sidebarItemsGenerator({defaultSidebarItemsGenerator, ...args}) {
            ...
            function sortVersions(items: typeof sidebarItems) {
  ...
  plugins: [
    ...
    function webpackOptimizationPlugin() {
      return {
        ...
        configureWebpack(config: {devtool?: string | false}) {
          return {
            cache: {
    ...
    [
      ...
      buildLlmsPluginOptions(generatedRoot),
    ],
  ],
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/Texarkanine/a16n',
          label: 'GitHub',
          position: 'right',
        },
      ],
